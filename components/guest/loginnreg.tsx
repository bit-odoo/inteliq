            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="midField">
                <form onSubmit={handleSignup}>
                  <div className="name">
                    <p>Email</p>
                    <div className="flex flex-row items-center gap-1 overflow-visible rounded-lg bg-white py-2 px-2 pl-2.5 pr-2 focus-within:ring-primary ring-1 ring-zinc-200 focus-within:shadow-input focus-within:shadow-primary/10 shadow-md transition-shadow">
                      <input
